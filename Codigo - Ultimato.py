...
class QuizApp:
    ...
    def mostrar_nova_rodada(self):
        ...
        self.current_question_index = 0
        # self.score = 0  # Comentando a linha para evitar que a pontuação seja reiniciada
...
class Jogo:
    def __init__(self, master):
        ...
        self.pontuacao = 0  # Adicionando variável de pontuação
    ...
    def reiniciar_jogo(self):
        ...
        self.atualizar_pontuacao()  # Atualiza a pontuação na interface gráfica
        self.iniciar_jogo()
    ...
    def iniciar_jogo(self):
        ...
        self.desenhar_grama()  # Desenhar a grama novamente
        ...
        self.passaro_id = self.canvas.create_image(50, 300, anchor=tk.NW, image=self.passaro)  # Desenhar o pássaro novamente
        self.move_animais()
